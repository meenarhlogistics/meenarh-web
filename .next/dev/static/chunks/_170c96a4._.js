...
const cartApi = {
    ...
    addToCart: async (item)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/cart', item);
        return response.data;
    },
    // Get user's cart
    getCart: async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get('/cart');
        return response.data;
    },
    // Update cart item
    updateCartItem: async (id, data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].patch(`/cart/${id}`, data);
        return response.data;
    },
    // Remove item from cart
    removeCartItem: async (id)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].delete(`/cart/${id}`);
        return response.data;
    },
    // Clear entire cart
    clearCart: async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].delete('/cart');
        return response.data;
    },
    // Checkout - create orders from cart items
    checkout: async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/cart/checkout');
        return response.data;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
_s(DashboardNav, "R/15Y4EMRl8IGNSCJMY9Tdsj9P0=", false, function() {
    return [
...
//# sourceMappingURL=_170c96a4._.js.map