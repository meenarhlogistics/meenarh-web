...
"[project]/app/admin/(dashboard)/blog/new/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewBlogPostPage() {
    ...
    const handleSave = async (status)=>{
        ...
        setSaving(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminApi"].createBlogPost({
                title: title.trim(),
                content,
...
_s(NewBlogPostPage, "BukREHTf+vLyRfSIoMSIAZmiViA=", false, function() {
    return [
...
//# sourceMappingURL=_2d4d33a0._.js.map