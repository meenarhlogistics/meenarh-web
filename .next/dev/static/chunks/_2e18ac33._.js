...
const authApi = {
    ...
    async login (credentials) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/user/login", credentials);
        return response.data;
    },
    // Signup
    async signup (userData) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/user/signup", userData);
        return response.data;
    },
    // Get user profile
    async getProfile () {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/user/profile");
        return response.data;
    },
    // Update user profile
    async updateProfile (userData) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch("/user/profile", userData);
        return response.data;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
function SignupPage() {
    ...
    const setAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "SignupPage.useAuthStore[setAuth]": (state)=>state.setAuth
    }["SignupPage.useAuthStore[setAuth]"]);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].signup(signupData);
            if (response.success) {
                // Store auth data
...
_s(SignupPage, "dhNjVnWakEyiV6Lhdl+A8BWqHuE=", false, function() {
    return [
...
//# sourceMappingURL=_2e18ac33._.js.map