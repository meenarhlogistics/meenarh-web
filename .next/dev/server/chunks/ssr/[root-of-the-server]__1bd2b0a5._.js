...
"[project]/lib/store/adminAuthStore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const useAdminAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set)=>({
        user: null,
        token: null,
...
"[project]/app/admin/(auth)/login/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$adminAuthStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/store/adminAuthStore.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function AdminLoginPage() {
    ...
    const { setAuth, isAuthenticated, loadAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$adminAuthStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminAuthStore"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].login(formData.email, formData.password);
            if (response.success) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1bd2b0a5._.js.map